...
public class XMainBoard {
	...
	private void initialize() {
		...
		tglbtnPowerOn.setUI(new MetalToggleButtonUI() {
		    @Override
		    protected Color getSelectColor() {
		        return Color.RED;
		    }
		});
		tglbtnPowerOn.addActionListener(new ActionListener() {
		...
		tglbtnOn.setUI(new MetalToggleButtonUI() {
		    @Override
		    protected Color getSelectColor() {
		        return Color.RED;
		    }
		...
		toggleButton_1.setUI(new MetalToggleButtonUI() {
		    @Override
		    protected Color getSelectColor() {
		        return Color.RED;
		    }
		...
		toggleButton_2.setUI(new MetalToggleButtonUI() {
		    @Override
		    protected Color getSelectColor() {
		        return Color.RED;
		    }
